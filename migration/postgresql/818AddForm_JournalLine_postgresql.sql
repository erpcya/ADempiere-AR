...
INSERT INTO AD_Form (AccessLevel,AD_Client_ID,AD_Form_ID,AD_Org_ID,Classname,Created,CreatedBy,EntityType,IsActive,IsBetaFunctionality,Name,Updated,UpdatedBy) VALUES ('3',0,1000001,0,'org.spin.form.VJournalLine',TO_TIMESTAMP('2014-10-20 11:06:36','YYYY-MM-DD HH24:MI:SS'),100,'ECA02','Y','N','Journal Line',TO_TIMESTAMP('2014-10-20 11:06:36','YYYY-MM-DD HH24:MI:SS'),100)
;
