...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Table_Trl SET Name='Línea de Jornada',Updated=TO_DATE('2014-10-14 10:38:00','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Table_ID=1000015 AND AD_Language='es_MX'
;
