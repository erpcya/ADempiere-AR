...
INSERT INTO AD_Form (AccessLevel,AD_Client_ID,AD_Form_ID,AD_Org_ID,Classname,Created,CreatedBy,EntityType,IsActive,IsBetaFunctionality,Name,Updated,UpdatedBy) VALUES ('3',0,1000000,0,'org.spin.form.VJournalDay',TO_DATE('2014-09-29 14:09:57','YYYY-MM-DD HH24:MI:SS'),100,'ECA02','Y','N','Journal Day',TO_DATE('2014-09-29 14:09:57','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- I forgot to set the DICTIONARY_ID_COMMENTS System Configurator
UPDATE AD_Form_Trl SET Name='Jornadas del Día',Updated=TO_DATE('2014-09-29 14:10:31','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Form_ID=1000000 AND AD_Language='es_MX'
;
